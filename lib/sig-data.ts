...
export const SIGNATURES: SignatureData[] = [
    {
        ...
        ctaHref: '#contact',
        thumbnail: '/sign-assets/john/thumbnail_pic.png',
        thumbnailAlt: 'Email signature design preview for a new real estate agent, Starter tier',
        images: [
            { src: '/sign-assets/john/thumbnail_pic.png', alt: 'New Agent signature thumbnail preview', label: 'Thumbnail' },
            { src: '/sign-assets/john/gmail_desk.png', alt: 'New Agent signature rendered in Gmail desktop', label: 'Gmail - Desktop' },
            { src: '/sign-assets/john/gmail_mob.png', alt: 'New Agent signature rendered in the Gmail mobile app', label: 'Gmail - Mobile' },
            { src: '/sign-assets/john/outlook_desk.png', alt: 'New Agent signature rendered in Outlook desktop', label: 'Outlook - Desktop' },
    ...
    },
    {
        ...
        ctaHref: '#contact',
        thumbnail: '/sign-assets/devon/thumbnail_pic.png',
        thumbnailAlt: 'Email signature design preview for a real estate listing specialist, Pro tier',
        images: [
            { src: '/sign-assets/devon/thumbnail_pic.png', alt: 'Listing Specialist signature thumbnail preview', label: 'Thumbnail' },
            { src: '/sign-assets/devon/gmail_desk.png', alt: 'Listing Specialist signature rendered in Gmail desktop', label: 'Gmail - Desktop' },
            { src: '/sign-assets/devon/gmail_mob.png', alt: 'Listing Specialist signature rendered in the Gmail mobile app', label: 'Gmail - Mobile' },
            { src: '/sign-assets/devon/outlook_desk.png', alt: 'Listing Specialist signature rendered in Outlook desktop', label: 'Outlook - Desktop' },
    ...
    },
    {
        ...
        ctaHref: '#contact',
        thumbnail: '/sign-assets/renee/thumbnail_pic.png',
        thumbnailAlt: 'Email signature design preview for a real estate team lead, Team tier',
        images: [
            { src: '/sign-assets/renee/thumbnail_pic.png', alt: 'Team Lead signature thumbnail preview', label: 'Thumbnail' },
            { src: '/sign-assets/renee/gmail_desk.png', alt: 'Team Lead signature rendered in Gmail desktop', label: 'Gmail - Desktop' },
            { src: '/sign-assets/renee/gmail_mob.png', alt: 'Team Lead signature rendered in the Gmail mobile app', label: 'Gmail - Mobile' },
            { src: '/sign-assets/renee/outlook_desk.png', alt: 'Team Lead signature rendered in Outlook desktop', label: 'Outlook - Desktop' },
